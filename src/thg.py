...
#
#         # 初始化 pipeline
#         self.inference = pipeline('talking-head', model=self.model_name, model_revision=self.model_revision)
#
#     def to_thg(self, driven_audio):
#         """
#         生成 Talking Head 视频。
...
#
#         try:
#             video_path = self.inference(self.source_image, driven_audio=driven_audio, **kwargs)
